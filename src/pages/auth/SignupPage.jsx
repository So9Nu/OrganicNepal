...
export default function SignupPage() {
    ...
    const allPasswordsMet = Object.values(passwordRequirements).every(
        (value) => value
    );
              ...
              Organic Nepal
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            ...
                            className="btn-primary w-full flex items-center justify-center gap-2 py-3.5 text-base transition disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
                                <>
